...
export function ContactSection() {
  ...
  const handleSubmit = (e) => {
    ...
    setFormData({ name: "", email: "", phone: "", venue: "", date: "", guests: "", message: "" });
  };
  ...
  return (
    <section style={{ padding: "60px 16px", background: "linear-gradient(to bottom, #ffffff, #fff5ec)" }}>
      <style>{`
        .contact-grid {
          display: flex;
      ...
      <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
        {/* Title */}
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }} style={{ textAlign: "center", marginBottom: "40px" }}>
          <span style={{ display: "inline-block", padding: "6px 20px", background: "rgba(197,157,95,0.15)", color: "#c59d5f", borderRadius: "50px", fontWeight: 600, marginBottom: "12px" }}>Contact Us</span>
          <h2 style={{ fontSize: "28px", fontWeight: 700, marginBottom: "12px" }}>Book Your Event With Us</h2>
          <p style={{ color: "#666", maxWidth: "500px", margin: "0 auto", fontSize: "15px" }}>Have questions or want to book your next event? Fill out the form — we’ll respond soon.</p>
        </motion.div>
        ...
        <div className="contact-grid">
          ...
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }}>
            <div style={{ background: "white", padding: "24px", borderRadius: "16px", boxShadow: "0 6px 20px rgba(0,0,0,0.1)" }}>
              <form onSubmit={handleSubmit} className="form-grid">
                ...
                <div className="form-grid two-cols">
                  ...
                  <div>
                    ...
                    <select value={formData.venue} onChange={(e) => handleChange("venue", e.target.value)} style={inputStyle}>
                ...
                <button style={submitButtonStyle}>Submit Inquiry <Send size={20} /></button>
              </form>
            </div>
          </motion.div>

          {/* Contact Info */}
          <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }} style={{ background: "#fff5ec", padding: "24px", borderRadius: "16px", boxShadow: "0 8px 25px rgba(0,0,0,0.08)", display: "flex", flexDirection: "column", gap: "20px", height: "fit-content" }}>
...
const inputStyle = { width: "100%", padding: "10px 14px", borderRadius: "10px", border: "1px solid #ccc", outline: "none", fontSize: "14px", boxSizing: "border-box" };
